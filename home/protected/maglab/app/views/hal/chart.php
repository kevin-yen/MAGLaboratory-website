...
<div <?php echo MtHaml\Runtime::renderAttributes(array(array('class', 'jumbotron'), array('style', ('margin-top: 100px;'))), 'html5', 'UTF-8'); ?>>
<div <?php echo MtHaml\Runtime::renderAttributes(array(array('class', 'container'), array('id', 'hal-graph'), array('style', ('height:500px;'))), 'html5', 'UTF-8'); ?>></div>
</div>
...
function drawChart(){
  ...
  dataTable.addRows(<?php echo '<?'; ?>php echo $this->data->graphJSON; ?>);
